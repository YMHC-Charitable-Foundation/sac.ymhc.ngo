...
**Working together to better understand absence from school & find effective inclusive, whole school solutions to the attendance, student mental health, and suicide crises.**
...
<div className="row">
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>About 25% of students experience school attendance challenges at some point during their schooling years, often related to anxiety or other mental health challenges.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}>Toronto Star, Feb. 21, 2023</div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>A study of Greater Toronto schools found a 600% increase in extreme absenteeism (missing more than 50% of classes) in 2021, affecting almost 9,000 students.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}>Toronto Star, 2023</div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>A CBC investigation reported around 50% of elementary students chronically absent in one Maritime school board in 2022–2023.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}>CBC</div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>New Brunswick example: In the Anglophone West School District, about 70% of secondary students were chronically absent in 2023.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}>Macleans</div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>In a national analysis of Canadian attendance data covering more than 740,000 students across 11 regions, researchers found that absenteeism rates increased significantly after COVID-19, reaching the highest recorded levels.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}><a href="https://cacap-acpea.org/wp-content/uploads/Impacts-of-COVID-19-on-School-Absenteeism-Among-Canadian-Children-and-Youth.pdf" target="_blank" rel="noopener noreferrer">CACAP-ACPEA</a></div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>School attendance is considered a key social determinant of child health, meaning consistent attendance is strongly connected to long-term well-being.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}><a href="https://cacap-acpea.org/wp-content/uploads/Impacts-of-COVID-19-on-School-Absenteeism-Among-Canadian-Children-and-Youth.pdf" target="_blank" rel="noopener noreferrer">CACAP-ACPEA</a></div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>Canada does not currently have national public data on school absenteeism, making it difficult to track trends or develop coordinated strategies.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC12350383/" target="_blank" rel="noopener noreferrer">NIH</a></div>
      </div>
    </div>
  </div>
  <div className="col col--4 margin-bottom--lg">
    <div className="card shadow--md h-100">
      <div className="card__body">
        <p>Canada has no national system for tracking school attendance, meaning attendance data is fragmented across provinces and school boards.</p>
        <div style={{fontSize: "0.85rem", opacity: 0.8}}><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC12350383/" target="_blank" rel="noopener noreferrer">NIH</a></div>
      </div>
    </div>
  </div>
